...
🔄 How It Works:
User Inputs: Genre + number of movies desired
Random Images Displayed: From the selected genre's folder
Each Image:
Resized to 150x150
Displayed with its genre label
Clean Output: Only images and titles shown — no extra messages unless there's an error
